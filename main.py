...
def send_start(message):
    if message.text == "/start":
        text = """🇺🇸 This bot can download videos and music from Facebook.
Send the link, choose the format and get your file.

🇷🇺 Этот бот может скачивать видео и музыку из Фейсбука.
...
"""
        ...
        text = """🔥 JustSave Facebook может скачать для вас видео ролики и аудио из Facebook.

Как пользоваться:
  1. Зайдите в Facebook.
